...
CREATE TABLE "Goal" (
    ...
    "monthlyAporte" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "Recommendation" (
    ...
    "essentialBudget" DOUBLE PRECISION NOT NULL,
    "investmentBudget" DOUBLE PRECISION NOT NULL,
    "freeBudget" DOUBLE PRECISION NOT NULL,
...
CREATE TABLE "BudgetSnapshot" (
    ...
    "totalEssential" DOUBLE PRECISION NOT NULL,
    "totalInstallments" DOUBLE PRECISION NOT NULL,
    "totalGoalAporte" DOUBLE PRECISION NOT NULL,
    "totalFree" DOUBLE PRECISION NOT NULL,
...
-- AddForeignKey
ALTER TABLE "InstallmentGroup" ADD CONSTRAINT "InstallmentGroup_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "BudgetSnapshot" ADD CONSTRAINT "BudgetSnapshot_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
